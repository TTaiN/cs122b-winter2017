...
<table>
	...
	<%
		...
		else
		{
			...
			{
				out.println("<tr>");
				out.println("<td class='info'>" + current.getId() + "</td>");
				out.println("<td class='info'><img class='banner' src='" + current.getBannerUrl() + "'/></td>");
				out.println("<td class='info'>" + current.getTitle() + " (" + current.getYear() + ")" + "</td>");
				out.println("<td class='info'>" + current.getDirector() + "</td>");
				...
				out.println("<input type='number' name='quantity" + current.getId() + "' value='" + cart.get(current) + "'/>");
